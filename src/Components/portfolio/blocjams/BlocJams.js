...
export default class BlocJams extends Component {
  ...
  componentDidMount() {
    ...
    // console.log(this.state.images, imgPath+"1.jpg", this.props.selected, piece, imgPath, piece.imgPath, portfolioData.portfolioPieces.filter(piece=>piece.slug==="blocjams")[0]))
